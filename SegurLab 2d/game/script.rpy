...
label Azul01:
    ...
    if answer =="A":
        "Errada! Essa opção representa uma substância oxidante. Clique para continuar."
    if answer =="D":
        "Errada! Essa opção representa uma substância explosiva. Clique para continuar."
    if answer =="C":
        "Errada! Você selecionou a cabeça do Vegeta, principe de todos os Saiyajins! Clique para continuar."
...
label Azul02:
    ...
    if answer == "B":
        ...
        "Correta! Seu score atual é : [score]. Clique para continuar."
    if answer =="A":
        "Errada! Você selecionou água, um reagente não corrosivo. Clique para continuar."
    if answer =="C":
        "Errada! Você selecionou etanol, um reagente não corrosivo. Clique para continuar."       
    if answer =="D":
        "Errada! Você selecionou carbonato de cálcio, um reagente não corrosivo. Clique para continuar."
...
label Azul03:
    ...
    if answer == "D":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Essa opção não representa um pictograma padrão GHS. Clique para continuar."
    if answer =="B":
        "Errada! Essa opção não representa um pictograma padrão GHS. Clique para continuar."
    if answer =="C":
        "Errada! Este pictograma não representa perigo ao ambiente. Clique para continuar."        
...
label Azul04:
    ...
    if answer == "B":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Essa opção não corresponde ao pictograma. Clique para continuar."
    if answer =="C":
        "Errada! Weyland-Yutani não adere ao padrão GHS de pictogramas! Clique para continuar."
    if answer =="D":
        "Errada! Essa opção não corresponde ao pictograma. Clique para continuar."        
...
label Azul05:
    ...
    if answer == "A":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="B":
        "Errada! I am the one who knocks! Clique para continuar." 
    if answer =="C":
        "Errada! Essa opção pode representar um pequeno perigo à saúde, mas não representa o maior perigo à saúde. Clique para continuar." 
    if answer =="D":
        "Errada! Essa opção não representa perigo à saúde. Clique para continuar."         
...
label Azul06:
    ...
    if answer == "C":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Ambos os reagentes desta opção não são representados pelo pictograma do cartão. Clique para continuar." 
    if answer =="B":
        "Errada! Ambos os reagentes desta opção não são representados pelo pictograma do cartão. Clique para continuar."  
    if answer =="D":
        "Errada! Ambos os reagentes desta opção não são representados pelo pictograma do cartão. Clique para continuar."         
...
label Azul07:
    ...
    if answer == "A":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="B":
        "Errada! Este pictograma pode representar perigo à saúde. Clique para continuar."
    if answer =="C":
        "Errada! Este pictograma representa perigo à saúde. Clique para continuar." 
    if answer =="D":
        "Errada! Este pictograma representa perigo à saúde. Clique para continuar."         
...
label Azul08:
    ...
    if answer == "D":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Esta é uma substância oxidante. Clique para continuar."
    if answer =="B":
        "Errada! Esta é uma substância oxidante. Clique para continuar."
    if answer =="C":
        "Errada! Esta é uma substância oxidante. Clique para continuar."        
...
label Azul09:
    ...
    if answer == "C":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Este pictograma não representa perigo à saúde. Clique para continuar." 
    if answer =="B":
        "Errada! Este pictograma não representa perigo à saúde. Clique para continuar." 
    if answer =="D":
        "Errada! Este pictograma não representa perigo à saúde. Clique para continuar."         
...
label Azul10:
    ...
    if answer == "C":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="D":
        "Errada! Este pictograma representa perigo físico. Clique para continuar."  
    if answer =="D":
        "Errada! Este pictograma representa perigo físico. Clique para continuar."  
    if answer =="D":
        "Errada! Este pictograma representa perigo físico. Clique para continuar."          
...
label Red01:
    ...
    if answer =="A":
        "Errada! Essa opção não representa um pictograma padrão GHS. Clique para continuar."
    if answer =="B":
        "Errada! Este pictograma pode representar perigo à saúde (inalação), contudo a frase de perigo seria diferente da apresentada no cartão. Clique para continuar."
    if answer =="C":
        "Errada! Este pictograma não representa perigo à saúde. Clique para continuar."        
...
label Red02:
    ...
    if answer == "C":
        ...
        $ nrquestoes = nrquestoes + 1
    if answer =="A":
        "Errada! Não corresponde ao pictograma do cartão. Clique para continuar."
    if answer =="B":
        "Errada! Não é umas das frases de perigo. Clique para continuar."
    if answer =="D":
        "Errada! Não corresponde ao pictograma do cartão. Clique para continuar."        
...
label Red03:
    ...
    if answer == "C":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Não representa a frase de perigo do cartão. Clique para continuar."
    if answer =="B":
        "Errada! Não representa a frase de perigo do cartão. Clique para continuar."
    if answer =="D":
        "Errada! Não representa a frase de perigo do cartão. O pictograma não representa perigo físico. Clique para continuar."        
...
label Red04:
    ...
    if answer == "D":
        ...
        $ nrquestoes = nrquestoes + 1
    if answer =="A":
        "Errada! A frase de perigo não exige pictograma. Clique para continuar." 
    if answer =="B":
        "Errada! Não contavam com minha astúcia! Clique para continuar."         
    if answer =="C":
        "Errada! Não corresponde ao pictograma do cartão. Clique para continuar." 
...
label Red05:
    ...
    if answer == "B":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Não apresenta perigo ao ambiente (sal de cozinha). Clique para continuar."
    if answer =="C":
        "Errada! Não apresenta perigo ao ambiente (ácido etanoico). Clique para continuar."
    if answer =="D":
        "Errada! Não apresenta perigo ao ambiente (bicarbonato de sódio). Clique para continuar."        
...
label Red06:
    ...
    if answer == "D":
        $ score = score + 10
        "Correta! Seu score atual é : [score]. Clique para continuar. Clique para continuar."
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Essa opção não representa um pictograma padrão GHS. Clique para continuar."
    if answer =="B":
        "Errada! Essa opção não representa perigo ao ambiente. Clique para continuar."
    if answer =="C":
        "Errada! Doh!"        
...
label Red07:
    ...
    if answer == "A":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="B":
        "Errada! Essa opção não é um gás sob pressão (ácido etanoico). Clique para continuar." 
    if answer =="C":
        "Errada! Não é um gás sob pressão (butanol). Clique para continuar." 
    if answer =="D":
        "Errada! Essa opção não representa um explosivo. Clique para continuar."         
...
label Red08:
    ...
    if answer == "B":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! O número 1 após o H não representa um código de frase de perigo."
    if answer =="C":
        "Errada! O número 3 após o H representa um perigo à saúde."
    if answer =="D":
        "Errada! O número 4 após o H representa um perigo ao meio ambiente."        
...
label Red09:
    ...
    if answer == "D":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Essa opção representa apenas perigo à saúde. Clique para continuar."
    if answer =="B":
        "Errada! Essa opção representa apenas perigo físico. Clique para continuar."
    if answer =="C":
        "Errada! Essa opção representa perigo à saúde ou ao ambiente. Clique para continuar."        
...
label Red10:
    ...
    if answer == "B":
        ...
        $ nrquestoes = nrquestoes + 1 
    if answer =="A":
        "Errada! Essa opção não corresponde ao pictograma da questão. Clique para continuar." 
    if answer =="C":
        "Errada! Essa opção não exige pictograma. Clique para continuar."   
    if answer =="D":
        "Errada! Essa opção não exige pictograma. Clique para continuar."         
