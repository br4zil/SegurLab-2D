...
define bottom_choice = True
screen choice(items):
    if bottom_choice:
        style_prefix "choice"
    else:
        style_prefix "bottom_choice"
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Quiz") action Start()
        ...
        textbutton _("Identificando Riscos") action Start("start2")
...
screen about():
    ...
    use game_menu(_("Créditos"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                spacing 15
                text "Chefe do Projeto"
                text "Dr. Marcelo Leandro Eichler"

            hbox:
                spacing 15
                text "Desenvolvedor e Game Designer"
                text "Ricardo dos Casaes Belo"

            hbox:
                spacing 15
                text "Designer Grafico"
                text "Ricardo dos Casaes Belo"
